import { Dots } from '@/components/ui/pagination/main-pagination-buttons/dots'
import { PageButton } from '@/components/ui/pagination/main-pagination-buttons/page-button'
